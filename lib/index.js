    ...
    _createClass(Wizard, [{
      ...
      value: function _getActiveWizardItem() {
        ...
        return this.wizardItems.find(function (item) {
          return item.props.id === _this3.state.active;
        });
      }
    }, {
      key: '_getWizardItem',
      ...
      key: '_getIdx',
      value: function _getIdx(id) {
        return this.wizardItems.findIndex(function (item) {
          return item.props.id === id;
        });
      }
    }, {
      key: '_hasIdx',
      value: function _hasIdx(idx) {
      ...
      value: function _popPrevious() {
        var last = this.state.previous.find(function (x, i, arr) {
      ...
      value: function _onNextClicked() {
        ...
        var promise = this._validate(id, value).then(function (value) {
          _this5._pushPrevious(id);

          _this5._setActiveById(next(value));
          _this5._setValidationClear(id);

          return value;
        }, function (err) {
          _this5._setValidationFail(id, err);
          if (promiseOnNext) {
            throw err;
          }
        });
...
var renderPropTypes = {
  ...
  values: _react2.default.PropTypes.object, //the cleared wizard values, ex. {label: 'Step 1', values: 'option1'} or {label: 'Step 1', values: { value: 'options1', label: 'Option 1'}}, or {label: 'Step 1', 
