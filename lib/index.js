  ...
  var Wizard = function (_React$Component) {
    ...
    _createClass(Wizard, [{
      ...
      value: function _popCleared() {
        this.setState({ cleared: this.state.cleared.filter(function (x, i, arr) {
            return i < arr.length - 1;
          }) });
        return this.state.cleared.find(function (x, i, arr) {
          return i === arr.length - 1;
        });
      }
    }, {
      ...
      value: function _validate(id, value) {
        ...
        return new Promise(function (resolve, reject) {
          try {
            validate(value);
            _this2._setValidationClear(id);
            return resolve(value);
          } catch (err) {
            _this2._setValidationFail(id, err);
            return reject(err);
          }
        });
      }
      ...
      value: function _onNextClicked() {
        ...
        return this._validate(id, value).then(function (value) {
          _this3._pushCleared(id);
          _this3._setActiveById(next(value));
          return value;
        }, function (err) {
          if (promiseOnNext) {
      ...
      value: function render() {
        ...
        return _react2.default.createElement(
          ...
          _react2.default.Children.map(this.wizardItems, function (Component, idx) {
            ...
            var value = values[id];
            var error = errors[id];
            var Child = _react2.default.Children.toArray(_this4.props.children).find(function (c, cidx) {
              return cidx === idx;
            });
            return _react2.default.createElement(Component.type, _extends({
              key: id,
              completed: completed,
              isActive: _this4._isActive(id),
            ...
            }, _this4.props.childrenProps, Component.props, Child.props));
          })
        );
      }
    }]);
...
var createWizardItem = function createWizardItem(WizardItemInner, WizardItemWrapper) {
  ...
  var WizardItem = function (_React$Component2) {
    ...
    function WizardItem(props) {
      ...
      var _this5 = _possibleConstructorReturn(this, (WizardItem.__proto__ || Object.getPrototypeOf(WizardItem)).call(this, props));

      _this5.renderWizardItem = renderWizardItem.bind(_this5);
      return _this5;
    }
